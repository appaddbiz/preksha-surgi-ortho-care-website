  ...
  return (
    <section className={`${page ? "cta-one--reverse" : "cta-one"}`}>
      <div className="cta-one__bg">
        {page ? null : (
          <div
            className="cta-one__bg__shape-left"
            style={{
              backgroundImage: `url(${rtl ? shapeLeftRtl.src : shapeLeft.src})`,
            }}
          ></div>
        )}
        <div
          className="cta-one__bg__shape"
          style={{
            backgroundImage: `url(${
              rtl ? shapeRtl.src : page ? shapeRtl.src : shape.src
            })`,
          }}
        ></div>
      </div>
      <Container>
        ...
        >
          <Col
            lg={7}
            className={`wow ${page ? "fadeInRight" : "fadeInLeft"} `}
            data-aos={`${page ? "fade-left" : "fade-right"} `}
            data-aos-delay="100"
          >
            <div className="cta-one__image">
              <Image
                src="/gallery/_JUP0326.webp"
                width={601}
                height={495}
                alt="tolak"
              />
          ...
          >
            <div className="cta-one__content">
              <div className="cta-one__box">
                <div className="cta-one__box__icon">
                  <Image src={icon} height={70} width={70} alt="" />
                </div>
                <h3 className="cta-one__box__title">{title}</h3>
                <p className="cta-one__box__text" style={{ color: "white" }}>
                  {text}
                </p>
              </div>
              {/* <div className="cta-one__author">
                ...
                <Link className="cta-one__author__rm" href={href}>
