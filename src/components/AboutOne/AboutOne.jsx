    ...
    <>
      <section className="about-one" id="about">
        ...
        <div
          ...
          style={{ backgroundImage: `url(${rtl ? shapeRtl.src : shape.src})` }}
        ></div>
        <Container>
          <Row>
            <Col
            ...
            >
              <div className="about-one__content">
                ...
                <p className="about-one__content__text" style={{color:"white"}}>
                  {text.split("\n").map((t, i) => (
                    <Fragment key={i}>
                      {t} <br />
                    </Fragment>
            ...
            <Col xl={6}>
              ...
              >
                <div
                  ...
                  data-aos={`${rtl ? "slide-right" : "slide-left"}`}
                  data-aos-easing="linear"
                  data-aos-duration="1500"
                >
                  <Image
                    src={"/home-images/Care-in-Surgery.jpg"}
                    width={917}
                    height={655}
                    alt="tolak"
                  />
