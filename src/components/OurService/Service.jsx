...
import combinedServiceData from "@/data/ServiceData";
...
const Service = ({ variant = "carousel" }) => {
  const { tagLine, title, carouselData, bg, shape, services } =
    combinedServiceData;
      ...
      <Container>
        ...
        {variant === "carousel" ? (
          ...
          <Row className="gutter-y-30">
            {services.map(({ id, image, icon, title, text, href }) => (
